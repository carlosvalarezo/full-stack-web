...
--
-- Name: categories; Type: TABLE; Schema: public; Owner: trivia
--
...
ALTER TABLE public.categories OWNER TO trivia;

--
-- Name: categories_id_seq; Type: SEQUENCE; Schema: public; Owner: trivia
--
...
ALTER TABLE public.categories_id_seq OWNER TO trivia;

--
-- Name: categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: trivia
--
...
--
-- Name: questions; Type: TABLE; Schema: public; Owner: trivia
--
...
ALTER TABLE public.questions OWNER TO trivia;

--
-- Name: questions_id_seq; Type: SEQUENCE; Schema: public; Owner: trivia
--
...
ALTER TABLE public.questions_id_seq OWNER TO trivia;

--
-- Name: questions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: trivia
--
...
--
-- Name: categories id; Type: DEFAULT; Schema: public; Owner: trivia
--
...
--
-- Name: questions id; Type: DEFAULT; Schema: public; Owner: trivia
--
...
--
-- Data for Name: categories; Type: TABLE DATA; Schema: public; Owner: trivia
--
...
--
-- Data for Name: questions; Type: TABLE DATA; Schema: public; Owner: trivia
--
...
--
-- Name: categories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: trivia
--
...
--
-- Name: questions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: trivia
--
...
--
-- Name: categories categories_pkey; Type: CONSTRAINT; Schema: public; Owner: trivia
--
...
--
-- Name: questions questions_pkey; Type: CONSTRAINT; Schema: public; Owner: trivia
--
...
--
-- Name: questions category; Type: FK CONSTRAINT; Schema: public; Owner: trivia
--
