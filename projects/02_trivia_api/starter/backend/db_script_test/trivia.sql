...
--
-- Name: categories; Type: TABLE; Schema: public; Owner: trivia_test
--
...
ALTER TABLE public.categories OWNER TO trivia_test;

--
-- Name: categories_id_seq; Type: SEQUENCE; Schema: public; Owner: trivia_test
--
...
ALTER TABLE public.categories_id_seq OWNER TO trivia_test;

--
-- Name: categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: trivia_test
--
...
--
-- Name: questions; Type: TABLE; Schema: public; Owner: trivia_test
--
...
ALTER TABLE public.questions OWNER TO trivia_test;

--
-- Name: questions_id_seq; Type: SEQUENCE; Schema: public; Owner: trivia_test
--
...
ALTER TABLE public.questions_id_seq OWNER TO trivia_test;

--
-- Name: questions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: trivia_test
--
...
--
-- Name: categories id; Type: DEFAULT; Schema: public; Owner: trivia_test
--
...
--
-- Name: questions id; Type: DEFAULT; Schema: public; Owner: trivia_test
--
